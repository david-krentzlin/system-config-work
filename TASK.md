...
3. Make sure gitu is configured so that I can use it comfortably alongside helix for a smooth git management experience
...
* you MUST make sure that keybidings between helix and wezterm, and gitu and wezterm don't conflict. I want to be able to use this comfortably
...
* Git: I want to be able to quickly fire up a split pane in the current project root with gitu running where I can interact (easy way to close it again is also required)


# References
* gitu (magit tui) https://raw.githubusercontent.com/altsem/gitu/refs/heads/master/README.md
...
* Git workflow: CTRL-t g opens gitu in a split pane at the project root; CTRL-t x closes panes.
